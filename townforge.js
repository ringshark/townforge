...
var ASM_CONSTS = {
  74060: () => { if (document.fullscreenElement) return 1; },  
 74106: () => { return document.getElementById('canvas').width; },  
 74158: () => { return parseInt(document.getElementById('canvas').style.width); },  
 74226: () => { document.exitFullscreen(); },  
 74253: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 74326: () => { if (document.fullscreenElement) return 1; },  
 74372: () => { return document.getElementById('canvas').width; },  
 74424: () => { return screen.width; },  
 74449: () => { document.exitFullscreen(); },  
 74476: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 74609: () => { return window.innerWidth; },  
 74635: () => { return window.innerHeight; },  
 74662: () => { if (document.fullscreenElement) return 1; },  
 74708: () => { return document.getElementById('canvas').width; },  
 74760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 74828: () => { if (document.fullscreenElement) return 1; },  
 74874: () => { return document.getElementById('canvas').width; },  
 74926: () => { return screen.width; },  
 74951: () => { return window.innerWidth; },  
 74977: () => { return window.innerHeight; },  
 75004: () => { if (document.fullscreenElement) return 1; },  
 75050: () => { return document.getElementById('canvas').width; },  
 75102: () => { return screen.width; },  
 75127: () => { document.exitFullscreen(); },  
 75154: () => { if (document.fullscreenElement) return 1; },  
 75200: () => { return document.getElementById('canvas').width; },  
 75252: () => { return parseInt(document.getElementById('canvas').style.width); },  
 75320: () => { document.exitFullscreen(); },  
 75347: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 75405: () => { return screen.width; },  
 75430: () => { return screen.height; },  
 75456: () => { return window.screenX; },  
 75483: () => { return window.screenY; },  
 75510: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 75563: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 75634: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 75691: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 75947: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 76018: () => { if (document.fullscreenElement) return 1; },  
 76064: () => { return window.innerWidth; },  
 76090: () => { return window.innerHeight; },  
 76117: () => { if (document.pointerLockElement) return 1; }
};
