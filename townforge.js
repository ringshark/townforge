...
var ASM_CONSTS = {
  75660: () => { if (document.fullscreenElement) return 1; },  
 75706: () => { return document.getElementById('canvas').width; },  
 75758: () => { return parseInt(document.getElementById('canvas').style.width); },  
 75826: () => { document.exitFullscreen(); },  
 75853: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 75926: () => { if (document.fullscreenElement) return 1; },  
 75972: () => { return document.getElementById('canvas').width; },  
 76024: () => { return screen.width; },  
 76049: () => { document.exitFullscreen(); },  
 76076: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 76209: () => { return window.innerWidth; },  
 76235: () => { return window.innerHeight; },  
 76262: () => { if (document.fullscreenElement) return 1; },  
 76308: () => { return document.getElementById('canvas').width; },  
 76360: () => { return parseInt(document.getElementById('canvas').style.width); },  
 76428: () => { if (document.fullscreenElement) return 1; },  
 76474: () => { return document.getElementById('canvas').width; },  
 76526: () => { return screen.width; },  
 76551: () => { return window.innerWidth; },  
 76577: () => { return window.innerHeight; },  
 76604: () => { if (document.fullscreenElement) return 1; },  
 76650: () => { return document.getElementById('canvas').width; },  
 76702: () => { return screen.width; },  
 76727: () => { document.exitFullscreen(); },  
 76754: () => { if (document.fullscreenElement) return 1; },  
 76800: () => { return document.getElementById('canvas').width; },  
 76852: () => { return parseInt(document.getElementById('canvas').style.width); },  
 76920: () => { document.exitFullscreen(); },  
 76947: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 77005: () => { return screen.width; },  
 77030: () => { return screen.height; },  
 77056: () => { return window.screenX; },  
 77083: () => { return window.screenY; },  
 77110: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 77163: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 77234: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 77291: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 77547: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 77618: () => { if (document.fullscreenElement) return 1; },  
 77664: () => { return window.innerWidth; },  
 77690: () => { return window.innerHeight; },  
 77717: () => { if (document.pointerLockElement) return 1; }
};
