...
var ASM_CONSTS = {
  72476: () => { if (document.fullscreenElement) return 1; },  
 72522: () => { return document.getElementById('canvas').width; },  
 72574: () => { return parseInt(document.getElementById('canvas').style.width); },  
 72642: () => { document.exitFullscreen(); },  
 72669: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 72742: () => { if (document.fullscreenElement) return 1; },  
 72788: () => { return document.getElementById('canvas').width; },  
 72840: () => { return screen.width; },  
 72865: () => { document.exitFullscreen(); },  
 72892: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 73025: () => { return window.innerWidth; },  
 73051: () => { return window.innerHeight; },  
 73078: () => { if (document.fullscreenElement) return 1; },  
 73124: () => { return document.getElementById('canvas').width; },  
 73176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 73244: () => { if (document.fullscreenElement) return 1; },  
 73290: () => { return document.getElementById('canvas').width; },  
 73342: () => { return screen.width; },  
 73367: () => { return window.innerWidth; },  
 73393: () => { return window.innerHeight; },  
 73420: () => { if (document.fullscreenElement) return 1; },  
 73466: () => { return document.getElementById('canvas').width; },  
 73518: () => { return screen.width; },  
 73543: () => { document.exitFullscreen(); },  
 73570: () => { if (document.fullscreenElement) return 1; },  
 73616: () => { return document.getElementById('canvas').width; },  
 73668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 73736: () => { document.exitFullscreen(); },  
 73763: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 73821: () => { return screen.width; },  
 73846: () => { return screen.height; },  
 73872: () => { return window.screenX; },  
 73899: () => { return window.screenY; },  
 73926: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 73979: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 74050: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 74107: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 74363: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 74434: () => { if (document.fullscreenElement) return 1; },  
 74480: () => { return window.innerWidth; },  
 74506: () => { return window.innerHeight; },  
 74533: () => { if (document.pointerLockElement) return 1; }
};
