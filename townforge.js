...
var ASM_CONSTS = {
  72924: () => { if (document.fullscreenElement) return 1; },  
 72970: () => { return document.getElementById('canvas').width; },  
 73022: () => { return parseInt(document.getElementById('canvas').style.width); },  
 73090: () => { document.exitFullscreen(); },  
 73117: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 73190: () => { if (document.fullscreenElement) return 1; },  
 73236: () => { return document.getElementById('canvas').width; },  
 73288: () => { return screen.width; },  
 73313: () => { document.exitFullscreen(); },  
 73340: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 73473: () => { return window.innerWidth; },  
 73499: () => { return window.innerHeight; },  
 73526: () => { if (document.fullscreenElement) return 1; },  
 73572: () => { return document.getElementById('canvas').width; },  
 73624: () => { return parseInt(document.getElementById('canvas').style.width); },  
 73692: () => { if (document.fullscreenElement) return 1; },  
 73738: () => { return document.getElementById('canvas').width; },  
 73790: () => { return screen.width; },  
 73815: () => { return window.innerWidth; },  
 73841: () => { return window.innerHeight; },  
 73868: () => { if (document.fullscreenElement) return 1; },  
 73914: () => { return document.getElementById('canvas').width; },  
 73966: () => { return screen.width; },  
 73991: () => { document.exitFullscreen(); },  
 74018: () => { if (document.fullscreenElement) return 1; },  
 74064: () => { return document.getElementById('canvas').width; },  
 74116: () => { return parseInt(document.getElementById('canvas').style.width); },  
 74184: () => { document.exitFullscreen(); },  
 74211: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 74269: () => { return screen.width; },  
 74294: () => { return screen.height; },  
 74320: () => { return window.screenX; },  
 74347: () => { return window.screenY; },  
 74374: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 74427: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 74498: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 74555: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 74811: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 74882: () => { if (document.fullscreenElement) return 1; },  
 74928: () => { return window.innerWidth; },  
 74954: () => { return window.innerHeight; },  
 74981: () => { if (document.pointerLockElement) return 1; }
};
