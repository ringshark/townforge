...
// include: C:\Users\markr\AppData\Local\Temp\tmpqsenc978.js
...
var ASM_CONSTS = {
  77996: () => { if (document.fullscreenElement) return 1; },  
 78042: () => { return document.getElementById('canvas').width; },  
 78094: () => { return parseInt(document.getElementById('canvas').style.width); },  
 78162: () => { document.exitFullscreen(); },  
 78189: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 78262: () => { if (document.fullscreenElement) return 1; },  
 78308: () => { return document.getElementById('canvas').width; },  
 78360: () => { return screen.width; },  
 78385: () => { document.exitFullscreen(); },  
 78412: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 78545: () => { return window.innerWidth; },  
 78571: () => { return window.innerHeight; },  
 78598: () => { if (document.fullscreenElement) return 1; },  
 78644: () => { return document.getElementById('canvas').width; },  
 78696: () => { return parseInt(document.getElementById('canvas').style.width); },  
 78764: () => { if (document.fullscreenElement) return 1; },  
 78810: () => { return document.getElementById('canvas').width; },  
 78862: () => { return screen.width; },  
 78887: () => { return window.innerWidth; },  
 78913: () => { return window.innerHeight; },  
 78940: () => { if (document.fullscreenElement) return 1; },  
 78986: () => { return document.getElementById('canvas').width; },  
 79038: () => { return screen.width; },  
 79063: () => { document.exitFullscreen(); },  
 79090: () => { if (document.fullscreenElement) return 1; },  
 79136: () => { return document.getElementById('canvas').width; },  
 79188: () => { return parseInt(document.getElementById('canvas').style.width); },  
 79256: () => { document.exitFullscreen(); },  
 79283: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 79341: () => { return screen.width; },  
 79366: () => { return screen.height; },  
 79392: () => { return window.screenX; },  
 79419: () => { return window.screenY; },  
 79446: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 79499: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 79570: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 79627: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 79883: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 79954: () => { if (document.fullscreenElement) return 1; },  
 80000: () => { return window.innerWidth; },  
 80026: () => { return window.innerHeight; },  
 80053: () => { if (document.pointerLockElement) return 1; }
};
