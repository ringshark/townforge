...
// include: C:\Users\markr\AppData\Local\Temp\tmpi7g6i6at.js
...
var ASM_CONSTS = {
  76508: () => { if (document.fullscreenElement) return 1; },  
 76554: () => { return document.getElementById('canvas').width; },  
 76606: () => { return parseInt(document.getElementById('canvas').style.width); },  
 76674: () => { document.exitFullscreen(); },  
 76701: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 76774: () => { if (document.fullscreenElement) return 1; },  
 76820: () => { return document.getElementById('canvas').width; },  
 76872: () => { return screen.width; },  
 76897: () => { document.exitFullscreen(); },  
 76924: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 77057: () => { return window.innerWidth; },  
 77083: () => { return window.innerHeight; },  
 77110: () => { if (document.fullscreenElement) return 1; },  
 77156: () => { return document.getElementById('canvas').width; },  
 77208: () => { return parseInt(document.getElementById('canvas').style.width); },  
 77276: () => { if (document.fullscreenElement) return 1; },  
 77322: () => { return document.getElementById('canvas').width; },  
 77374: () => { return screen.width; },  
 77399: () => { return window.innerWidth; },  
 77425: () => { return window.innerHeight; },  
 77452: () => { if (document.fullscreenElement) return 1; },  
 77498: () => { return document.getElementById('canvas').width; },  
 77550: () => { return screen.width; },  
 77575: () => { document.exitFullscreen(); },  
 77602: () => { if (document.fullscreenElement) return 1; },  
 77648: () => { return document.getElementById('canvas').width; },  
 77700: () => { return parseInt(document.getElementById('canvas').style.width); },  
 77768: () => { document.exitFullscreen(); },  
 77795: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 77853: () => { return screen.width; },  
 77878: () => { return screen.height; },  
 77904: () => { return window.screenX; },  
 77931: () => { return window.screenY; },  
 77958: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 78011: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 78082: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 78139: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 78395: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 78466: () => { if (document.fullscreenElement) return 1; },  
 78512: () => { return window.innerWidth; },  
 78538: () => { return window.innerHeight; },  
 78565: () => { if (document.pointerLockElement) return 1; }
};
