...
// include: C:\Users\markr\AppData\Local\Temp\tmpjoaki1pk.js
...
var ASM_CONSTS = {
  77980: () => { if (document.fullscreenElement) return 1; },  
 78026: () => { return document.getElementById('canvas').width; },  
 78078: () => { return parseInt(document.getElementById('canvas').style.width); },  
 78146: () => { document.exitFullscreen(); },  
 78173: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 78246: () => { if (document.fullscreenElement) return 1; },  
 78292: () => { return document.getElementById('canvas').width; },  
 78344: () => { return screen.width; },  
 78369: () => { document.exitFullscreen(); },  
 78396: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 78529: () => { return window.innerWidth; },  
 78555: () => { return window.innerHeight; },  
 78582: () => { if (document.fullscreenElement) return 1; },  
 78628: () => { return document.getElementById('canvas').width; },  
 78680: () => { return parseInt(document.getElementById('canvas').style.width); },  
 78748: () => { if (document.fullscreenElement) return 1; },  
 78794: () => { return document.getElementById('canvas').width; },  
 78846: () => { return screen.width; },  
 78871: () => { return window.innerWidth; },  
 78897: () => { return window.innerHeight; },  
 78924: () => { if (document.fullscreenElement) return 1; },  
 78970: () => { return document.getElementById('canvas').width; },  
 79022: () => { return screen.width; },  
 79047: () => { document.exitFullscreen(); },  
 79074: () => { if (document.fullscreenElement) return 1; },  
 79120: () => { return document.getElementById('canvas').width; },  
 79172: () => { return parseInt(document.getElementById('canvas').style.width); },  
 79240: () => { document.exitFullscreen(); },  
 79267: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 79325: () => { return screen.width; },  
 79350: () => { return screen.height; },  
 79376: () => { return window.screenX; },  
 79403: () => { return window.screenY; },  
 79430: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 79483: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 79554: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 79611: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 79867: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 79938: () => { if (document.fullscreenElement) return 1; },  
 79984: () => { return window.innerWidth; },  
 80010: () => { return window.innerHeight; },  
 80037: () => { if (document.pointerLockElement) return 1; }
};
