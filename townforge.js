...
var ASM_CONSTS = {
  78012: () => { if (document.fullscreenElement) return 1; },  
 78058: () => { return document.getElementById('canvas').width; },  
 78110: () => { return parseInt(document.getElementById('canvas').style.width); },  
 78178: () => { document.exitFullscreen(); },  
 78205: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 78278: () => { if (document.fullscreenElement) return 1; },  
 78324: () => { return document.getElementById('canvas').width; },  
 78376: () => { return screen.width; },  
 78401: () => { document.exitFullscreen(); },  
 78428: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 78561: () => { return window.innerWidth; },  
 78587: () => { return window.innerHeight; },  
 78614: () => { if (document.fullscreenElement) return 1; },  
 78660: () => { return document.getElementById('canvas').width; },  
 78712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 78780: () => { if (document.fullscreenElement) return 1; },  
 78826: () => { return document.getElementById('canvas').width; },  
 78878: () => { return screen.width; },  
 78903: () => { return window.innerWidth; },  
 78929: () => { return window.innerHeight; },  
 78956: () => { if (document.fullscreenElement) return 1; },  
 79002: () => { return document.getElementById('canvas').width; },  
 79054: () => { return screen.width; },  
 79079: () => { document.exitFullscreen(); },  
 79106: () => { if (document.fullscreenElement) return 1; },  
 79152: () => { return document.getElementById('canvas').width; },  
 79204: () => { return parseInt(document.getElementById('canvas').style.width); },  
 79272: () => { document.exitFullscreen(); },  
 79299: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 79357: () => { return screen.width; },  
 79382: () => { return screen.height; },  
 79408: () => { return window.screenX; },  
 79435: () => { return window.screenY; },  
 79462: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 79515: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 79586: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 79643: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 79899: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 79970: () => { if (document.fullscreenElement) return 1; },  
 80016: () => { return window.innerWidth; },  
 80042: () => { return window.innerHeight; },  
 80069: () => { if (document.pointerLockElement) return 1; }
};
