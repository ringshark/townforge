...
// include: C:\Users\markr\AppData\Local\Temp\tmpltkm3t5p.js
...
var ASM_CONSTS = {
  74876: () => { if (document.fullscreenElement) return 1; },  
 74922: () => { return document.getElementById('canvas').width; },  
 74974: () => { return parseInt(document.getElementById('canvas').style.width); },  
 75042: () => { document.exitFullscreen(); },  
 75069: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 75142: () => { if (document.fullscreenElement) return 1; },  
 75188: () => { return document.getElementById('canvas').width; },  
 75240: () => { return screen.width; },  
 75265: () => { document.exitFullscreen(); },  
 75292: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 75425: () => { return window.innerWidth; },  
 75451: () => { return window.innerHeight; },  
 75478: () => { if (document.fullscreenElement) return 1; },  
 75524: () => { return document.getElementById('canvas').width; },  
 75576: () => { return parseInt(document.getElementById('canvas').style.width); },  
 75644: () => { if (document.fullscreenElement) return 1; },  
 75690: () => { return document.getElementById('canvas').width; },  
 75742: () => { return screen.width; },  
 75767: () => { return window.innerWidth; },  
 75793: () => { return window.innerHeight; },  
 75820: () => { if (document.fullscreenElement) return 1; },  
 75866: () => { return document.getElementById('canvas').width; },  
 75918: () => { return screen.width; },  
 75943: () => { document.exitFullscreen(); },  
 75970: () => { if (document.fullscreenElement) return 1; },  
 76016: () => { return document.getElementById('canvas').width; },  
 76068: () => { return parseInt(document.getElementById('canvas').style.width); },  
 76136: () => { document.exitFullscreen(); },  
 76163: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 76221: () => { return screen.width; },  
 76246: () => { return screen.height; },  
 76272: () => { return window.screenX; },  
 76299: () => { return window.screenY; },  
 76326: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 76379: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 76450: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 76507: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 76763: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 76834: () => { if (document.fullscreenElement) return 1; },  
 76880: () => { return window.innerWidth; },  
 76906: () => { return window.innerHeight; },  
 76933: () => { if (document.pointerLockElement) return 1; }
};
