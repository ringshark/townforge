...
// include: C:\Users\markr\AppData\Local\Temp\tmp5njhzir2.js
...
var ASM_CONSTS = {
  74204: () => { if (document.fullscreenElement) return 1; },  
 74250: () => { return document.getElementById('canvas').width; },  
 74302: () => { return parseInt(document.getElementById('canvas').style.width); },  
 74370: () => { document.exitFullscreen(); },  
 74397: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 74470: () => { if (document.fullscreenElement) return 1; },  
 74516: () => { return document.getElementById('canvas').width; },  
 74568: () => { return screen.width; },  
 74593: () => { document.exitFullscreen(); },  
 74620: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 74753: () => { return window.innerWidth; },  
 74779: () => { return window.innerHeight; },  
 74806: () => { if (document.fullscreenElement) return 1; },  
 74852: () => { return document.getElementById('canvas').width; },  
 74904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 74972: () => { if (document.fullscreenElement) return 1; },  
 75018: () => { return document.getElementById('canvas').width; },  
 75070: () => { return screen.width; },  
 75095: () => { return window.innerWidth; },  
 75121: () => { return window.innerHeight; },  
 75148: () => { if (document.fullscreenElement) return 1; },  
 75194: () => { return document.getElementById('canvas').width; },  
 75246: () => { return screen.width; },  
 75271: () => { document.exitFullscreen(); },  
 75298: () => { if (document.fullscreenElement) return 1; },  
 75344: () => { return document.getElementById('canvas').width; },  
 75396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 75464: () => { document.exitFullscreen(); },  
 75491: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 75549: () => { return screen.width; },  
 75574: () => { return screen.height; },  
 75600: () => { return window.screenX; },  
 75627: () => { return window.screenY; },  
 75654: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 75707: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 75778: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 75835: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 76091: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 76162: () => { if (document.fullscreenElement) return 1; },  
 76208: () => { return window.innerWidth; },  
 76234: () => { return window.innerHeight; },  
 76261: () => { if (document.pointerLockElement) return 1; }
};
