...
// include: C:\Users\markr\AppData\Local\Temp\tmpo2q3puro.js
...
var ASM_CONSTS = {
  75644: () => { if (document.fullscreenElement) return 1; },  
 75690: () => { return document.getElementById('canvas').width; },  
 75742: () => { return parseInt(document.getElementById('canvas').style.width); },  
 75810: () => { document.exitFullscreen(); },  
 75837: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 75910: () => { if (document.fullscreenElement) return 1; },  
 75956: () => { return document.getElementById('canvas').width; },  
 76008: () => { return screen.width; },  
 76033: () => { document.exitFullscreen(); },  
 76060: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 76193: () => { return window.innerWidth; },  
 76219: () => { return window.innerHeight; },  
 76246: () => { if (document.fullscreenElement) return 1; },  
 76292: () => { return document.getElementById('canvas').width; },  
 76344: () => { return parseInt(document.getElementById('canvas').style.width); },  
 76412: () => { if (document.fullscreenElement) return 1; },  
 76458: () => { return document.getElementById('canvas').width; },  
 76510: () => { return screen.width; },  
 76535: () => { return window.innerWidth; },  
 76561: () => { return window.innerHeight; },  
 76588: () => { if (document.fullscreenElement) return 1; },  
 76634: () => { return document.getElementById('canvas').width; },  
 76686: () => { return screen.width; },  
 76711: () => { document.exitFullscreen(); },  
 76738: () => { if (document.fullscreenElement) return 1; },  
 76784: () => { return document.getElementById('canvas').width; },  
 76836: () => { return parseInt(document.getElementById('canvas').style.width); },  
 76904: () => { document.exitFullscreen(); },  
 76931: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 76989: () => { return screen.width; },  
 77014: () => { return screen.height; },  
 77040: () => { return window.screenX; },  
 77067: () => { return window.screenY; },  
 77094: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 77147: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 77218: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 77275: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 77531: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 77602: () => { if (document.fullscreenElement) return 1; },  
 77648: () => { return window.innerWidth; },  
 77674: () => { return window.innerHeight; },  
 77701: () => { if (document.pointerLockElement) return 1; }
};
