...
var ASM_CONSTS = {
  149446: () => { if (document.fullscreenElement) return 1; },  
 149492: () => { return document.getElementById('canvas').width; },  
 149544: () => { return parseInt(document.getElementById('canvas').style.width); },  
 149612: () => { document.exitFullscreen(); },  
 149639: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 149712: () => { if (document.fullscreenElement) return 1; },  
 149758: () => { return document.getElementById('canvas').width; },  
 149810: () => { return screen.width; },  
 149835: () => { document.exitFullscreen(); },  
 149862: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 149995: () => { return window.innerWidth; },  
 150021: () => { return window.innerHeight; },  
 150048: () => { if (document.fullscreenElement) return 1; },  
 150094: () => { return document.getElementById('canvas').width; },  
 150146: () => { return parseInt(document.getElementById('canvas').style.width); },  
 150214: () => { if (document.fullscreenElement) return 1; },  
 150260: () => { return document.getElementById('canvas').width; },  
 150312: () => { return screen.width; },  
 150337: () => { return window.innerWidth; },  
 150363: () => { return window.innerHeight; },  
 150390: () => { if (document.fullscreenElement) return 1; },  
 150436: () => { return document.getElementById('canvas').width; },  
 150488: () => { return screen.width; },  
 150513: () => { document.exitFullscreen(); },  
 150540: () => { if (document.fullscreenElement) return 1; },  
 150586: () => { return document.getElementById('canvas').width; },  
 150638: () => { return parseInt(document.getElementById('canvas').style.width); },  
 150706: () => { document.exitFullscreen(); },  
 150733: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 150791: () => { return screen.width; },  
 150816: () => { return screen.height; },  
 150842: () => { return window.screenX; },  
 150869: () => { return window.screenY; },  
 150896: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 150949: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 151020: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 151077: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 151333: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 151404: () => { if (document.fullscreenElement) return 1; },  
 151450: () => { return window.innerWidth; },  
 151476: () => { return window.innerHeight; },  
 151503: () => { if (document.pointerLockElement) return 1; }
};
