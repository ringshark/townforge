...
// include: C:\Users\markr\AppData\Local\Temp\tmpgbmdtg7a.js
...
var ASM_CONSTS = {
  74476: () => { if (document.fullscreenElement) return 1; },  
 74522: () => { return document.getElementById('canvas').width; },  
 74574: () => { return parseInt(document.getElementById('canvas').style.width); },  
 74642: () => { document.exitFullscreen(); },  
 74669: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 74742: () => { if (document.fullscreenElement) return 1; },  
 74788: () => { return document.getElementById('canvas').width; },  
 74840: () => { return screen.width; },  
 74865: () => { document.exitFullscreen(); },  
 74892: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 75025: () => { return window.innerWidth; },  
 75051: () => { return window.innerHeight; },  
 75078: () => { if (document.fullscreenElement) return 1; },  
 75124: () => { return document.getElementById('canvas').width; },  
 75176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 75244: () => { if (document.fullscreenElement) return 1; },  
 75290: () => { return document.getElementById('canvas').width; },  
 75342: () => { return screen.width; },  
 75367: () => { return window.innerWidth; },  
 75393: () => { return window.innerHeight; },  
 75420: () => { if (document.fullscreenElement) return 1; },  
 75466: () => { return document.getElementById('canvas').width; },  
 75518: () => { return screen.width; },  
 75543: () => { document.exitFullscreen(); },  
 75570: () => { if (document.fullscreenElement) return 1; },  
 75616: () => { return document.getElementById('canvas').width; },  
 75668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 75736: () => { document.exitFullscreen(); },  
 75763: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 75821: () => { return screen.width; },  
 75846: () => { return screen.height; },  
 75872: () => { return window.screenX; },  
 75899: () => { return window.screenY; },  
 75926: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 75979: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 76050: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 76107: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 76363: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 76434: () => { if (document.fullscreenElement) return 1; },  
 76480: () => { return window.innerWidth; },  
 76506: () => { return window.innerHeight; },  
 76533: () => { if (document.pointerLockElement) return 1; }
};
