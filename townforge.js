...
var ASM_CONSTS = {
  74140: () => { if (document.fullscreenElement) return 1; },  
 74186: () => { return document.getElementById('canvas').width; },  
 74238: () => { return parseInt(document.getElementById('canvas').style.width); },  
 74306: () => { document.exitFullscreen(); },  
 74333: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 74406: () => { if (document.fullscreenElement) return 1; },  
 74452: () => { return document.getElementById('canvas').width; },  
 74504: () => { return screen.width; },  
 74529: () => { document.exitFullscreen(); },  
 74556: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 74689: () => { return window.innerWidth; },  
 74715: () => { return window.innerHeight; },  
 74742: () => { if (document.fullscreenElement) return 1; },  
 74788: () => { return document.getElementById('canvas').width; },  
 74840: () => { return parseInt(document.getElementById('canvas').style.width); },  
 74908: () => { if (document.fullscreenElement) return 1; },  
 74954: () => { return document.getElementById('canvas').width; },  
 75006: () => { return screen.width; },  
 75031: () => { return window.innerWidth; },  
 75057: () => { return window.innerHeight; },  
 75084: () => { if (document.fullscreenElement) return 1; },  
 75130: () => { return document.getElementById('canvas').width; },  
 75182: () => { return screen.width; },  
 75207: () => { document.exitFullscreen(); },  
 75234: () => { if (document.fullscreenElement) return 1; },  
 75280: () => { return document.getElementById('canvas').width; },  
 75332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 75400: () => { document.exitFullscreen(); },  
 75427: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 75485: () => { return screen.width; },  
 75510: () => { return screen.height; },  
 75536: () => { return window.screenX; },  
 75563: () => { return window.screenY; },  
 75590: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 75643: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 75714: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 75771: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 76027: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 76098: () => { if (document.fullscreenElement) return 1; },  
 76144: () => { return window.innerWidth; },  
 76170: () => { return window.innerHeight; },  
 76197: () => { if (document.pointerLockElement) return 1; }
};
