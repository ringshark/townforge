...
// include: C:\Users\markr\AppData\Local\Temp\tmpjxtvgle2.js
...
var ASM_CONSTS = {
  78124: () => { if (document.fullscreenElement) return 1; },  
 78170: () => { return document.getElementById('canvas').width; },  
 78222: () => { return parseInt(document.getElementById('canvas').style.width); },  
 78290: () => { document.exitFullscreen(); },  
 78317: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 78390: () => { if (document.fullscreenElement) return 1; },  
 78436: () => { return document.getElementById('canvas').width; },  
 78488: () => { return screen.width; },  
 78513: () => { document.exitFullscreen(); },  
 78540: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 78673: () => { return window.innerWidth; },  
 78699: () => { return window.innerHeight; },  
 78726: () => { if (document.fullscreenElement) return 1; },  
 78772: () => { return document.getElementById('canvas').width; },  
 78824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 78892: () => { if (document.fullscreenElement) return 1; },  
 78938: () => { return document.getElementById('canvas').width; },  
 78990: () => { return screen.width; },  
 79015: () => { return window.innerWidth; },  
 79041: () => { return window.innerHeight; },  
 79068: () => { if (document.fullscreenElement) return 1; },  
 79114: () => { return document.getElementById('canvas').width; },  
 79166: () => { return screen.width; },  
 79191: () => { document.exitFullscreen(); },  
 79218: () => { if (document.fullscreenElement) return 1; },  
 79264: () => { return document.getElementById('canvas').width; },  
 79316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 79384: () => { document.exitFullscreen(); },  
 79411: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 79469: () => { return screen.width; },  
 79494: () => { return screen.height; },  
 79520: () => { return window.screenX; },  
 79547: () => { return window.screenY; },  
 79574: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 79627: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 79698: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 79755: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 80011: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 80082: () => { if (document.fullscreenElement) return 1; },  
 80128: () => { return window.innerWidth; },  
 80154: () => { return window.innerHeight; },  
 80181: () => { if (document.pointerLockElement) return 1; }
};
